...
public class Player {
	...
	public Card chooseCard() {
		...
		if (card1.getCardName() == "Condesa" && (card2.getCardName() == "Rey" || card2.getCardName() == "Principe")) {
			chosenCard = card1;
			card1 = card2;
			card2 = null;
			return chosenCard;
		...
		if (card2.getCardName() == "Condesa" && (card1.getCardName() == "Rey" || card1.getCardName() == "Principe")) {
			chosenCard = card2;
			card2 = null;
		}
